"""Reviewed golden linkage authority for all 49 canonical patterns.
...
This file is a reviewed static authority, not derived from production
heuristics.  It was generated once from the corrected canonical YAML
and pinned here; runtime tests compare against these static values
rather than re-deriving expected links with production/migration logic.
"""
